...
namespace OazachaosuCore.Test.ApiControllersTests
{
    ...
    public class ResultsControllerGetTests
    {
        ...
        public void Check_results_count()
        {
            ...
            {
                JsonResult result = new ResultsController(new WordkiRepo(context)).Get2(headerElementProviderMock.Object) as JsonResult;
                ...
                IEnumerable<ResultDTO> results = apiResult.Object as IEnumerable<ResultDTO>;
        ...
        public void Check_result_count_by_user()
        {
            using (var context = new ApplicationDbContext(Options))
            {
                ...
                group.AddResult(new Result() { Id = 100, GroupId = group.Id });
        ...
        public void Check_word_count_by_last_change()
        {
            using (var context = new ApplicationDbContext(Options))
            {
                ...
                group.AddResult(new Result() { Id = 100, GroupId = group.Id, LastChange = new DateTime(1990, 1, 1) });
                context.Groups.Add(group);
                context.SaveChanges();
            }
            using (var context = new ApplicationDbContext(Options))
